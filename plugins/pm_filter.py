...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            return await query.answer(' whats this ')
        ...
        return await query.answer(' Doing E=mc² ')
        ...
        return await query.answer(' h@ck¡ng ')
        ...
        return await query.answer(' braining ')
        ...
        return await query.answer(' calling god ')
        ...
        if groupids is None:
            ...
            return await query.answer(' where i am ')
        buttons = []
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await client.send_photo(chat_id=query.from_user.id, photo='', caption = f"<b>📕Nᴀᴍᴇ ➠ : <code>{files.file_name}</code> \n\n🔗Sɪᴢᴇ ➠ : {get_size(files.file_size)}</b>", 
        ...
        buttons = [[
            ...
            InlineKeyboardButton("▶️ Y0UTUBE DOWNLOADER 🎦", callback_data='video')
        ],[
            InlineKeyboardButton('🔭 STATISTICS 📊', callback_data='stats')
        ],[
            InlineKeyboardButton('‹‹‹⬅ GO BACK', callback_data='about')
        ]]       
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('‹‹‹⬅ GO BACK', callback_data='mods')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('📞 COMMUNICATE 📟', callback_data='contact')
        ], [
            InlineKeyboardButton('‹‹‹⬅ GO BACK', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('😳 CREATOR 😳', url='https://t.me/ideafy')
        ], [     
            InlineKeyboardButton('📞 COMMUNICATION 📟', url='https://t.me/yedekho_in')
        ], [  
            InlineKeyboardButton('‹‹‹⬅ GO BACK', callback_data='about')
        ], [
        ]]
