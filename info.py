...
BOT_TOKEN = environ.get('BOT_TOKEN', '6286222522:AAExtmKF2PCX_Oi_NfEFjH8qRIL3rqfpkPM')
# Bot settings
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1867884587 1009704073 2006604853 5749820434').split()]
...
auth_grp = environ.get('AUTH_GROUP', '-1001811233102')
...
aLOG_STR += (f"CUSTOM_FILE_CAPTION enabled with value {CUSTOM_FILE_CAPTION}, your files will be send along with this customized caption.\n" if CUSTOM_FILE_CAPTION else "No CUSTOM_FILE_CAPTION Found, Default captions of file will be used.\n")
